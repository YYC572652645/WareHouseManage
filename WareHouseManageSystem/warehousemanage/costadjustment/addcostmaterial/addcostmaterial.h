#ifndef ADDCOSTMATRIAL_H
#define ADDCOSTMATRIAL_H
...
namespace Ui {
class addcostmaterial;
}

class AddCostMaterial : public QWidget
{
    Q_OBJECT

public:
    enum WIDGETTYPE{EDITTYPE, ADDTYPE};
    explicit AddCostMaterial(QWidget *parent = 0); //构造函数
    ~AddCostMaterial();                            //析构函数
