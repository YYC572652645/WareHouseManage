#ifndef EXTENDADJEMAIL_H
#define EXTENDADJEMAIL_H
...
namespace Ui {
class ExtendAdjEmail;
}

class ExtendAdjEmail : public QWidget
{
    Q_OBJECT

public:
    explicit ExtendAdjEmail(QWidget *parent = 0);   //构造函数
    ~ExtendAdjEmail();                              //析构函数
