/********************************************************************************
** Form generated from reading UI file 'addcostmaterial.ui'
**
...
#ifndef UI_ADDCOSTMATERIAL_H
#define UI_ADDCOSTMATERIAL_H
...
public:
    ...
    void setupUi(QWidget *addcostmaterial)
    {
        if (addcostmaterial->objectName().isEmpty())
            addcostmaterial->setObjectName(QStringLiteral("addcostmaterial"));
        addcostmaterial->resize(711, 634);
        addcostmaterial->setStyleSheet(QStringLiteral(""));
        verticalLayout = new QVBoxLayout(addcostmaterial);
        ...
        tableWidgetData = new QTableWidget(addcostmaterial);
        ...
        tableWidgetEditData = new QTableWidget(addcostmaterial);
        ...
        checkBoxAllSelect = new QCheckBox(addcostmaterial);
        ...
        pushButtonSave = new QPushButton(addcostmaterial);
        ...
        pushButtonDel = new QPushButton(addcostmaterial);
        ...
        pushButtonCancel = new QPushButton(addcostmaterial);
        ...
        retranslateUi(addcostmaterial);

        QMetaObject::connectSlotsByName(addcostmaterial);
    } // setupUi

    void retranslateUi(QWidget *addcostmaterial)
    {
        addcostmaterial->setWindowTitle(QApplication::translate("addcostmaterial", "Form", 0));
        QTableWidgetItem *___qtablewidgetitem = tableWidgetData->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("addcostmaterial", "\345\216\237\346\226\231\345\220\215\347\247\260", 0));
        QTableWidgetItem *___qtablewidgetitem1 = tableWidgetData->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("addcostmaterial", "\345\216\237\346\226\231\347\274\226\347\240\201", 0));
        QTableWidgetItem *___qtablewidgetitem2 = tableWidgetData->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QApplication::translate("addcostmaterial", "\350\260\203\344\273\267\345\211\215", 0));
        QTableWidgetItem *___qtablewidgetitem3 = tableWidgetData->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QApplication::translate("addcostmaterial", "\350\260\203\344\273\267\345\220\216", 0));
        QTableWidgetItem *___qtablewidgetitem4 = tableWidgetData->horizontalHeaderItem(4);
        ___qtablewidgetitem4->setText(QApplication::translate("addcostmaterial", "\345\215\225\344\275\215", 0));
        QTableWidgetItem *___qtablewidgetitem5 = tableWidgetEditData->horizontalHeaderItem(0);
        ___qtablewidgetitem5->setText(QApplication::translate("addcostmaterial", "\345\216\237\346\226\231\345\220\215\347\247\260", 0));
        QTableWidgetItem *___qtablewidgetitem6 = tableWidgetEditData->horizontalHeaderItem(1);
        ___qtablewidgetitem6->setText(QApplication::translate("addcostmaterial", "\345\216\237\346\226\231\347\274\226\347\240\201", 0));
        QTableWidgetItem *___qtablewidgetitem7 = tableWidgetEditData->horizontalHeaderItem(2);
        ___qtablewidgetitem7->setText(QApplication::translate("addcostmaterial", "\350\260\203\344\273\267\345\211\215", 0));
        QTableWidgetItem *___qtablewidgetitem8 = tableWidgetEditData->horizontalHeaderItem(3);
        ___qtablewidgetitem8->setText(QApplication::translate("addcostmaterial", "\350\260\203\344\273\267\345\220\216", 0));
        QTableWidgetItem *___qtablewidgetitem9 = tableWidgetEditData->horizontalHeaderItem(4);
        ___qtablewidgetitem9->setText(QApplication::translate("addcostmaterial", "\345\215\225\344\275\215", 0));
        checkBoxAllSelect->setText(QApplication::translate("addcostmaterial", "\345\205\250\351\200\211", 0));
        pushButtonSave->setText(QApplication::translate("addcostmaterial", " \344\277\235\345\255\230", 0));
        pushButtonDel->setText(QApplication::translate("addcostmaterial", " \345\210\240\351\231\244", 0));
        pushButtonCancel->setText(QApplication::translate("addcostmaterial", " \345\217\226\346\266\210", 0));
    } // retranslateUi

};

namespace Ui {
    class addcostmaterial: public Ui_addcostmaterial {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_ADDCOSTMATERIAL_H
