/********************************************************************************
** Form generated from reading UI file 'materialstoinfo.ui'
**
...
#ifndef UI_MATERIALSTOINFO_H
#define UI_MATERIALSTOINFO_H
...
public:
    ...
    void setupUi(QWidget *materialstoinfo)
    {
        if (materialstoinfo->objectName().isEmpty())
            materialstoinfo->setObjectName(QStringLiteral("materialstoinfo"));
        materialstoinfo->resize(535, 656);
        verticalLayout_3 = new QVBoxLayout(materialstoinfo);
        ...
        scrollAreaSide = new QScrollArea(materialstoinfo);
...
""));
        ...
        dateEditTime = new QDateEdit(scrollAreaWidgetContents);
        dateEditTime->setObjectName(QStringLiteral("dateEditTime"));
        dateEditTime->setMinimumSize(QSize(220, 30));
        dateEditTime->setMaximumSize(QSize(200, 30));

        horizontalLayout_9->addWidget(dateEditTime);
...
"}"));
        ...
        QWidget::setTabOrder(lineEditBarCode, dateEditTime);

        retranslateUi(materialstoinfo);

        QMetaObject::connectSlotsByName(materialstoinfo);
    } // setupUi

    void retranslateUi(QWidget *materialstoinfo)
    {
        materialstoinfo->setWindowTitle(QApplication::translate("materialstoinfo", "Form", 0));
        label_19->setText(QApplication::translate("materialstoinfo", " \345\237\272\346\234\254\344\277\241\346\201\257", 0));
        label->setText(QApplication::translate("materialstoinfo", "\345\216\237\346\226\231\345\220\215\347\247\260\357\274\232", 0));
        label_2->setText(QApplication::translate("materialstoinfo", "\346\235\241\345\275\242\347\240\201\357\274\232", 0));
        labelNowNumber->setText(QApplication::translate("materialstoinfo", "\344\270\273\345\205\245\345\272\223\344\273\223\345\272\223\357\274\232", 0));
        labelUnit->setText(QApplication::translate("materialstoinfo", "\345\215\225\344\275\215\357\274\232", 0));
        labelUnitPrice->setText(QApplication::translate("materialstoinfo", "\345\215\225\344\273\267\357\274\232", 0));
        labelNowNumber_2->setText(QApplication::translate("materialstoinfo", "\347\224\237\344\272\247\346\227\245\346\234\237\357\274\232", 0));
        labelNumber->setText(QApplication::translate("materialstoinfo", "\345\205\245\345\272\223\346\225\260\351\207\217\357\274\232", 0));
        label_4->setText(QApplication::translate("materialstoinfo", "\351\207\221\351\242\235(\345\205\203)\357\274\232", 0));
        labelSide->setText(QApplication::translate("materialstoinfo", " \345\210\206\344\273\223\345\205\245\345\272\223", 0));
        pushButtonAddNew->setText(QApplication::translate("materialstoinfo", " \346\267\273\345\212\240\346\226\260\347\232\204\345\210\206\344\273\223\345\205\245\345\272\223...", 0));
        pushButtonSave->setText(QApplication::translate("materialstoinfo", " \344\277\235\345\255\230", 0));
        pushButtonDel->setText(QApplication::translate("materialstoinfo", " \345\210\240\351\231\244", 0));
        pushButtonCancel->setText(QApplication::translate("materialstoinfo", " \345\217\226\346\266\210", 0));
    } // retranslateUi

};

namespace Ui {
    class materialstoinfo: public Ui_materialstoinfo {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_MATERIALSTOINFO_H
