/********************************************************************************
** Form generated from reading UI file 'extendadjemail.ui'
**
...
#ifndef UI_EXTENDADJEMAIL_H
#define UI_EXTENDADJEMAIL_H
...
public:
    ...
    void setupUi(QWidget *ExtendAdjEmail)
    {
        if (ExtendAdjEmail->objectName().isEmpty())
            ExtendAdjEmail->setObjectName(QStringLiteral("ExtendAdjEmail"));
        ExtendAdjEmail->resize(653, 580);
        verticalLayout_2 = new QVBoxLayout(ExtendAdjEmail);
        ...
        tableWidgetData = new QTableWidget(ExtendAdjEmail);
        ...
        checkBoxAllSelect = new QCheckBox(ExtendAdjEmail);
        ...
        labelEmail = new QLabel(ExtendAdjEmail);
        ...
        lineEditEmail = new QLineEdit(ExtendAdjEmail);
        ...
        pushButtonExport = new QPushButton(ExtendAdjEmail);
        ...
        retranslateUi(ExtendAdjEmail);

        QMetaObject::connectSlotsByName(ExtendAdjEmail);
    } // setupUi

    void retranslateUi(QWidget *ExtendAdjEmail)
    {
        ExtendAdjEmail->setWindowTitle(QApplication::translate("ExtendAdjEmail", "Form", 0));
        QTableWidgetItem *___qtablewidgetitem = tableWidgetData->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("ExtendAdjEmail", "\344\273\223\345\272\223\345\220\215\347\247\260", 0));
        QTableWidgetItem *___qtablewidgetitem1 = tableWidgetData->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("ExtendAdjEmail", "\350\260\203\346\225\264\345\215\225\345\217\267", 0));
        QTableWidgetItem *___qtablewidgetitem2 = tableWidgetData->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QApplication::translate("ExtendAdjEmail", "\350\260\203\346\225\264\346\227\245\346\234\237", 0));
        QTableWidgetItem *___qtablewidgetitem3 = tableWidgetData->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QApplication::translate("ExtendAdjEmail", "\347\212\266\346\200\201", 0));
        checkBoxAllSelect->setText(QApplication::translate("ExtendAdjEmail", "\345\205\250\351\200\211", 0));
        labelEmail->setText(QApplication::translate("ExtendAdjEmail", "\351\202\256\347\256\261\357\274\232", 0));
        pushButtonExport->setText(QApplication::translate("ExtendAdjEmail", " \345\257\274\345\207\272", 0));
    } // retranslateUi

};

namespace Ui {
    class ExtendAdjEmail: public Ui_ExtendAdjEmail {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_EXTENDADJEMAIL_H
