/********************************************************************************
** Form generated from reading UI file 'extendretemail.ui'
**
...
#ifndef UI_EXTENDRETEMAIL_H
#define UI_EXTENDRETEMAIL_H
...
public:
    ...
    void setupUi(QWidget *ExtendRetEmail)
    {
        if (ExtendRetEmail->objectName().isEmpty())
            ExtendRetEmail->setObjectName(QStringLiteral("ExtendRetEmail"));
        ExtendRetEmail->resize(626, 577);
        verticalLayout_2 = new QVBoxLayout(ExtendRetEmail);
        ...
        tableWidgetData = new QTableWidget(ExtendRetEmail);
        ...
        checkBoxAllSelect = new QCheckBox(ExtendRetEmail);
        ...
        labelEmail = new QLabel(ExtendRetEmail);
        ...
        lineEditEmail = new QLineEdit(ExtendRetEmail);
        ...
        pushButtonExport = new QPushButton(ExtendRetEmail);
        ...
        retranslateUi(ExtendRetEmail);

        QMetaObject::connectSlotsByName(ExtendRetEmail);
    } // setupUi

    void retranslateUi(QWidget *ExtendRetEmail)
    {
        ExtendRetEmail->setWindowTitle(QApplication::translate("ExtendRetEmail", "Form", 0));
        QTableWidgetItem *___qtablewidgetitem = tableWidgetData->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("ExtendRetEmail", "\344\276\233\345\272\224\345\225\206", 0));
        QTableWidgetItem *___qtablewidgetitem1 = tableWidgetData->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("ExtendRetEmail", "\351\200\200\350\264\247\345\215\225\345\217\267", 0));
        QTableWidgetItem *___qtablewidgetitem2 = tableWidgetData->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QApplication::translate("ExtendRetEmail", "\351\200\200\350\264\247\346\227\245\346\234\237", 0));
        QTableWidgetItem *___qtablewidgetitem3 = tableWidgetData->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QApplication::translate("ExtendRetEmail", "\347\212\266\346\200\201", 0));
        checkBoxAllSelect->setText(QApplication::translate("ExtendRetEmail", "\345\205\250\351\200\211", 0));
        labelEmail->setText(QApplication::translate("ExtendRetEmail", "\351\202\256\347\256\261\357\274\232", 0));
        pushButtonExport->setText(QApplication::translate("ExtendRetEmail", " \345\257\274\345\207\272", 0));
    } // retranslateUi

};

namespace Ui {
    class ExtendRetEmail: public Ui_ExtendRetEmail {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_EXTENDRETEMAIL_H
