/********************************************************************************
** Form generated from reading UI file 'extendstorage.ui'
**
...
#ifndef UI_EXTENDSTORAGE_H
#define UI_EXTENDSTORAGE_H
...
public:
    ...
    void setupUi(QWidget *ExtendStorage)
    {
        if (ExtendStorage->objectName().isEmpty())
            ExtendStorage->setObjectName(QStringLiteral("ExtendStorage"));
        ExtendStorage->resize(633, 607);
        verticalLayout_2 = new QVBoxLayout(ExtendStorage);
        ...
        tableWidgetData = new QTableWidget(ExtendStorage);
        ...
        checkBoxAllSelect = new QCheckBox(ExtendStorage);
        ...
        labelEmail = new QLabel(ExtendStorage);
        ...
        lineEditEmail = new QLineEdit(ExtendStorage);
        ...
        pushButtonExport = new QPushButton(ExtendStorage);
        ...
        retranslateUi(ExtendStorage);

        QMetaObject::connectSlotsByName(ExtendStorage);
    } // setupUi

    void retranslateUi(QWidget *ExtendStorage)
    {
        ExtendStorage->setWindowTitle(QApplication::translate("ExtendStorage", "Form", 0));
        QTableWidgetItem *___qtablewidgetitem = tableWidgetData->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("ExtendStorage", "\344\276\233\345\272\224\345\225\206", 0));
        QTableWidgetItem *___qtablewidgetitem1 = tableWidgetData->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("ExtendStorage", "\351\207\207\350\264\255\345\215\225\345\217\267", 0));
        QTableWidgetItem *___qtablewidgetitem2 = tableWidgetData->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QApplication::translate("ExtendStorage", "\350\246\201\346\261\202\345\210\260\350\264\247\346\227\245", 0));
        QTableWidgetItem *___qtablewidgetitem3 = tableWidgetData->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QApplication::translate("ExtendStorage", "\347\212\266\346\200\201", 0));
        checkBoxAllSelect->setText(QApplication::translate("ExtendStorage", "\345\205\250\351\200\211", 0));
        labelEmail->setText(QApplication::translate("ExtendStorage", "\351\202\256\347\256\261\357\274\232", 0));
        pushButtonExport->setText(QApplication::translate("ExtendStorage", " \345\257\274\345\207\272", 0));
    } // retranslateUi

};

namespace Ui {
    class ExtendStorage: public Ui_ExtendStorage {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_EXTENDSTORAGE_H
